    ...
    private BDLocationListener mListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (null != location && location.getLocType() != BDLocation.TypeServerError) {
                ...
                sharedPreferences.edit().putString(CommonConstField.LOCATION_CITY, location.getCity()).commit();
                sharedPreferences.edit().putString(CommonConstField.LOCATION_DISTRICT, location.getDistrict()).commit();
            }
        }
