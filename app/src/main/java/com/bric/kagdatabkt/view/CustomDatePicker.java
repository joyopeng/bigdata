package com.bric.kagdatabkt.view;
...
public class CustomDatePicker {
    ...
    public CustomDatePicker(Context context, String title, ResultHandler resultHandler, String startDate, String endDate, float y) {
    ...
    private void initDialog(float y) {
